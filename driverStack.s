...
.extern stackConstructor, stackDestructor, stackPush, stackPop, delete
.extern putstring, printf
...
continueProgram:
	...
	RET							// back to libc (was: MOV X8, #93 / SVC 0)
...
szFloatFmt:		.asciz "%.2f\n"
	...
	.align	3				// doubles must be 8-byte aligned
dValue1:		.double 1.1
dValue2:		.double 2.2
dValue3:		.double 3.3
dValue4:		.double 4.4
